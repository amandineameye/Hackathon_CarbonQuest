         ...
         <main className="flex flex-1 py-4">
            <div className="container flex flex-col xl:flex-row gap-4">
               <div className="flex flex-col  w-full xl:w-1/2 bg-[#f5f8f6] rounded-lg justify-center py-10 px-10">
                  ...
                  <div>
                     <p className="pb-4">
                        Carbon Quest est un <span className="font-semibold">jeu éducatif</span> de plates-formes qui vous invite à explorer les enjeux du <span className="font-semibold">Green IT</span>, l’ensemble des pratiques visant à réduire l’impact environnemental des technologies numériques, de leur conception à leur utilisation.
                     </p>
